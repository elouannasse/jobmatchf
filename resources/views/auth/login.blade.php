        ...
        <div class="row g-0 justify-content-center bg-primary-dark-op">
            <div class="hero-static col-sm-8 col-md-6 col-xl-4 d-flex align-items-center p-2 px-sm-0">
                ...
                <div class="block block-transparent block-rounded w-100 mb-0 overflow-hidden">
                    <div class="block-content block-content-full px-lg-5 px-xl-5 py-4 py-md-5 py-lg-6 bg-body-extra-light">
                        <!-- Header -->
                        ...
                        <form class="js-validation-signin" method="POST">
                            ...
                            <div
                                ...
                                <div class="form-check">
                                    <input type="checkbox" class="form-check-input" id="login-remember-me" name="remember"
                            ...
                            <div class="text-center mb-4">
                                ...
                                <p class="mt-3 mb-0 d-lg-flex justify-content-lg-between gap-lg-2">
                                    ...
                                    @endif
                                    <a class="btn btn-sm btn-alt-secondary d-block d-lg-inline-block mb-1" <i
                                        class="fa fa-plus opacity-50 me-1"></i> {{__('New Account')}}
                                    </a>
                                </p>
                            </div>
                        </form>
